---
name: crear-skill
description: Genera directorios de skills (.agent/skills/) siguiendo estándares de Antigravity. Úsese cuando el usuario solicite crear una nueva habilidad o automatización para el agente.
---
